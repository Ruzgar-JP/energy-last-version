      ...
      <section className="relative min-h-[92vh] flex items-center bg-[#0A2220] overflow-hidden" data-testid="hero-section">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 py-32 w-full">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="bg-emerald-500/20 text-emerald-300 border-emerald-500/30 mb-6 px-4 py-1.5 text-sm backdrop-blur-sm">Yenilenebilir Enerji Yatırım Platformu</Badge>
              ...
              <p className="text-lg md:text-xl text-emerald-100/90 mb-3 font-semibold drop-shadow-md">RES & GES Projelerinde Aylık %8'e Varan Getiri</p>
            ...
            <div className="hidden lg:block">
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { icon: TrendingUp, value: '%8', label: 'Maks. Aylık Getiri', color: 'from-amber-500/20 to-orange-500/20' },
                ].map((stat, i) => (
      ...
      <section className="py-20 md:py-28 bg-white" data-testid="steps-section">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-base md:text-lg text-slate-500 mt-3 max-w-2xl mx-auto">Basit ve şeffaf sürecimiz ile düşük riskle yüksek getirili yenilenebilir enerji yatırımlarında ortak olun.</p>
          </div>
          <div className="grid md:grid-cols-4 gap-6">
            {[
              ...
              { icon: Wallet, title: 'Yatırım Portföyünüzü Kurun', desc: 'Banka hesabınızdan havale/EFT ile bakiye yükleyin. Size uygun yatırım planını seçin: 25.000 TL ile başlayın, hisse adetinizi artırdıkça getiri oranınız da artsın.', time: '10 dakika' },
        ...
        <div className="max-w-3xl mx-auto px-4 md:px-8">
          ...
          <Accordion type="single" collapsible className="space-y-3">
            {[
              ...
              { q: 'Yatırımlarımı geri çekebilir miyim?', a: 'Evet dilediğiniz zaman hisselerinizin devrini sağlayabilirsiniz , devredecek biriniz bulamadığınız takdirde hissedarlar arasında alıcılı piyasada devrini sağlayabilir ya da şirket bünyesine devredip kazancınızı alabilirisiniz.' },
