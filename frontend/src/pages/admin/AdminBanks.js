    ...
    <AdminLayout>
      <div data-testid="admin-banks">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-2xl font-bold text-slate-900 font-[Manrope]">Bankalar</h1>
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DialogContent>
            <DialogHeader><DialogTitle className="font-[Manrope]">{editBank ? 'Banka Duzenle' : 'Yeni Banka Ekle'}</DialogTitle></DialogHeader>
