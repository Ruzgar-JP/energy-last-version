    ...
    <footer className="bg-[#0A2724] text-white" data-testid="footer">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            <h4 className="font-[Sora] font-semibold mb-4 text-emerald-400 text-sm uppercase tracking-wider">Yatırım</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="font-[Sora] font-semibold mb-4 text-emerald-400 text-sm uppercase tracking-wider">İletişim</h4>
            <ul className="space-y-3">
