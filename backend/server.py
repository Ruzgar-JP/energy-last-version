...
async def seed_data():
    ...
    if await db.projects.count_documents({}) == 0:
        await db.projects.insert_many([
            {"project_id": str(uuid.uuid4()), "name": "Izmir Gunes Enerjisi Santrali", "type": "GES",
             "description": "Izmir'in Torbali ilcesinde 175 donum arazi uzerinde kurulu gunes enerjisi santrali. Yilda 22.000 MWh enerji uretimi hedeflenmektedir.",
